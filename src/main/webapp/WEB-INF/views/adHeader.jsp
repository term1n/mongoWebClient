...
<head>
    ...
    <script src="<c:url value="/resources/scripts/libs/jQuery.validate.js"/>"></script>
    ...
    <%--custom scripts--%>
    <script src="<c:url value="/resources/scripts/js/admin/app.js"/>"></script>
    <script src="<c:url value="/resources/scripts/js/admin/nuserMan/MWCAdminNuserMan.js"/>"></script>
